...
export function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-green-500/20 bg-forest text-white">
      <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-transparent via-earth/70 to-transparent" />
      ...
      <div className="container-x relative py-14 lg:py-20">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.25fr_0.9fr_0.9fr_1.25fr]">
          <div className="space-y-5">
            ...
            <div>
              <p className="text-sm font-bold text-beige">{COMPANY_INFO.marathiSlogan}</p>
          ...
          <div>
            <h3 className="flex items-center gap-2 text-sm font-extrabold uppercase text-beige">
            ...
            <ul className="mt-5 grid gap-3 text-sm text-white/76">
              {quickLinks.map(({ icon: Icon, label, to }) => (
                <li key={label}>
                  <Link
                    to={to}
                    className="flex items-center gap-2.5 transition hover:translate-x-1 hover:text-beige"
                  >
          ...
          <div>
            ...
            <div className="mt-5 grid gap-4 text-sm text-white/76">
              ...
              <a
                ...
                className="flex items-center gap-2.5 hover:text-beige"
              >
              ...
              <a
                ...
                className="flex items-center gap-2.5 break-all hover:text-beige"
              >
              ...
              <div className="flex flex-wrap gap-3 pt-1">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 rounded-full border border-earth/30 px-4 py-2 text-xs font-extrabold text-cream transition hover:-translate-y-0.5 hover:bg-earth/10"
                >
                  Website
        ...
        <div className="container-x flex flex-col items-center justify-between gap-4 text-center text-xs text-white/70 md:flex-row md:text-left">
          <p>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="font-extrabold text-beige hover:underline"
            >
              Webakoof
            </a>
          </p>
